				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>存款人爱好：</td>
								<td><input type="checkbox" id="pLike1" name="pLike" value="篮球">篮球
								<input type="checkbox" id="pLike2" name="pLike" value="足球">足球
								<input type="checkbox" id="pLike3" name="pLike" value="排球">排球
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>存款人性别：</td>
								<td><input type="radio" id="pSex" name="pSex" value="男">男
								<input type="radio" id="pSex" name="pSex" value="女">女
									</td>
							</tr>
							<tr>
								<td>存款金额：</td>
