				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>学生性别：</td>
								<td><input type="radio" id="sdsex" name="sdsex" value="男">男
								<input type="radio" id="sdsex" name="sdsex" value="女">女
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>学生爱好：</td>
								<td><input type="checkbox" id="sdhobby1" name="sdhobby" value="篮球">篮球
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_delete").click(function(){
	    		...
	    		if(getSelections && getSelections.length>0){
	    			...
	    			$("#select_message").modal({backdrop: 'static', keyboard: false});
	    			$("#alertmod_table_user_mod").show();
	    		}
	        });
	    	//导出
