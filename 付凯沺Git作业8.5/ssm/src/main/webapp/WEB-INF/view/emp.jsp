...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">日期区间查询 </span>
					...
					<form id="form_user" method="post" action="reserveEmp.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>用户爱好：</td>
								<td><input type="checkbox" id="hobby1" name="hobby" value="篮球">篮球
								<input type="checkbox" id="hobby2" name="hobby" value="足球">足球
								<input type="checkbox" id="hobby3" name="hobby" value="乒乓球">乒乓球
									</td>
							</tr>
							<tr>
								<td>用户部门：</td>
	...
	function initEditUser(getSelection){
		...
		$('#hobby3').prop('checked',getSelection.hobby.indexOf("乒乓球")!=-1);
