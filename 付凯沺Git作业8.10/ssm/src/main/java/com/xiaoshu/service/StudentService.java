...
public class StudentService {
	...
	// 通过用户名判断是否存在，（新增时不能重名）
	public Student existStudentWithStudentName(String userName) throws Exception {
	...
	public PageInfo<StudentVo> findStudentPage(StudentVo sv, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
		List<StudentVo> userList = sm.findAllStudent(sv);
